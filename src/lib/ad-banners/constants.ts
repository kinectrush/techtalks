/** Site-wide placements; desktop/mobile detail slots are per-article on review_articles. */
...
export const AD_BANNER_PLACEMENT_LABELS: Record<AdBannerPlacement, string> = {
  ...
  review_detail_popup:
    'Trang chi tiết bài viết — Popup (9:16, dialog giữa màn hình)',
};
